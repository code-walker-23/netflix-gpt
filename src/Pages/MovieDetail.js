...
import MovieDetailsCard from "../components/MovieDetail/MovieDetailsCard";
...
import MovieTranslations from "../components/MovieDetail/MovieTranslations";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-8 space-x-4">
            ...
            <button
              className="bg-indigo-600 text-white py-2 px-4 rounded shadow hover:bg-indigo-700 focus:outline-none"
              onClick={() =>
                translationsRef.current.scrollIntoView({ behavior: "smooth" })
              }
            >
              Translations
            </button>
