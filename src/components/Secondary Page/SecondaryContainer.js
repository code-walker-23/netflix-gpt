...
const SecondaryContainer = () => {
  ...
  return (
    <div className="p-8 bg-gray-900 text-white min-h-screen">
      <div className="mb-12">
        <h2 className="text-4xl font-extrabold mb-6 border-b-4 border-red-600 pb-2">Movies</h2>
      ...
      <div>
        <h2 className="text-4xl font-extrabold mb-6 border-b-4 border-green-600 pb-2">TV Shows</h2>
        <div className="space-y-10">
